...
import { BOOKING_STATUS, StudentBookingStatus } from "@/constants/booking/BookingStatus";
...
export default function StudentBookingStatusModal({
    booking,
    open,
    onOpenChange,
    onSuccess,
    ...
    const form = useForm({
        ...
        onSubmit: async ({ value }) => {
            ...
            const result = await bookingClientService.updateStudentBookingStatus(
                booking.id,
                value.status as StudentBookingStatus
            );
