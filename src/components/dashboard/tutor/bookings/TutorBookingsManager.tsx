...
import TutorBookingsFilters from "./TutorBookingsFilters";
...
export default function TutorBookingsManager() {
    ...
    useEffect(() => {
        const fetchSessions = async () => {
            try {
                ...
                const res =
                    await bookingClientService.getMine({
                        page,
                        limit: 8,
    ...
    return (
        <div className="space-y-8">
            ...
            <SectionHeader
                title="My Bookings"
                description="Manage your upcoming student bookings."
            />

            <TutorBookingsFilters
                status={status}
                startDate={startDate}
                endDate={endDate}
